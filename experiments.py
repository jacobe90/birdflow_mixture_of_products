...
if __name__=="__main__":
    mixture_of_products_grid_search([1e-4], [1e-2], [0.4], [250, 450, 650], save_dir="/work/pi_drsheldon_umass_edu/birdflow_modeling/jacob_independent_study/mixture_of_products/experiments/training_speed_stress_test")
